      ...
      <main className="flex-grow pt-16">
        ...
        <section className="relative bg-white overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-32 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link href="/register" className="inline-block px-8 py-4 bg-indigo-600 text-white font-bold rounded-xl shadow-xl hover:bg-indigo-700 hover:shadow-indigo-500/30 transition-all duration-300 hover:scale-105 active:scale-95 text-lg w-full sm:w-auto">
                Commencer gratuitement
              </Link>
              <Link href="#problem" className="inline-block px-8 py-4 bg-white text-slate-700 font-bold rounded-xl border border-slate-200 shadow-sm hover:bg-slate-50 transition-all duration-300 hover:scale-105 active:scale-95 text-lg w-full sm:w-auto">
        ...
        <section className="py-24 bg-gradient-to-br from-indigo-600 to-purple-700 text-white text-center">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <Link href="/register" className="inline-block px-10 py-5 bg-white text-indigo-700 font-bold rounded-xl shadow-2xl hover:bg-slate-50 transition transform hover:scale-105 active:scale-95 text-lg">
